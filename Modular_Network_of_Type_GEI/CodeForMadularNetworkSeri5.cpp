////////////////////////////////////////////////
// Implementation code for Madular netwok for Seri5: 0.00001 < eta < 0.0001
...
#define dEta  0.00001   // eta step
#define etaFinal 0.0001  // end of eta space: dEta < eta < etaFinal 
...
{  
    ...
    ifstream input_file_blocks("./BlockNodesNumberTypeGEI.txt"); 
    ...
    ifstream input_file("./MadularAdjListTypeGEI.txt"); 
    int n1,n2,n3,i,j,k;
 	input_file >> n1 >> n2 >> n3 ;
 ...
 for (pNodeE=dEta ; pNodeE<etaFinal ; pNodeE += dEta){
	...
	string name1 = "./ActiveExcDensK200T1X150Seri5R"; 
	string name2 = "./ActiveInhDensK200T1X150Seri5R"; 
