...
#define dEta  0.0001   // eta step
#define etaFinal 0.001  // end of eta space: dEta < eta < etaFinal 
...
{  
 ...
 for (pNodeE=dEta ; pNodeE<etaFinal ; pNodeE += dEta){
	...
	string name1 = "./ActiveExcDensK200T1X150Seri4R"; 
	string name2 = "./ActiveInhDensK200T1X150Seri4R"; 
